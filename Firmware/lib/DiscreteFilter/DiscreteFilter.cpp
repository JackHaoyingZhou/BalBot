...
/**
 * Static default constructor array placeholder
 */
float DiscreteFilter::ab_ph[1] = { 1.0f };

/**
 * @brief Constructs discrete filter with given coefficients.
 ...
 */
DiscreteFilter::DiscreteFilter() :
	DiscreteFilter(1, ab_ph, 1, ab_ph)
{
	return;
}
 ...
 */
float DiscreteFilter::update(float xn)
{
 ...
 */
DiscreteFilter operator*(DiscreteFilter f1, DiscreteFilter f2)
{
	// Allocate data
 ...
 */
DiscreteFilter DiscreteFilter::make_lpf(float f_cutoff, float f_sample)
{
	// Allocate data
 ...
 * @param f_sample Sample frequency [Hz]
 */
DiscreteFilter DiscreteFilter::make_hpf(float f_cutoff, float f_sample)
{
	// Allocate data
	const uint8_t A = 2; float a[A];
 ...
 */
DiscreteFilter DiscreteFilter::make_int(float f_sample)
{
	// Allocate data
	const uint8_t A = 2; float a[A];
	const uint8_t B = 1; float b[B];
 ...
 * @param f_sampel Sample frequency [Hz]
 */
DiscreteFilter DiscreteFilter::make_dif(float f_sample)
{
	// Allocate data
